...
variants = collect(Iterators.product([1f0, 0.1f0, 0.01f0],[1f0, 0.5f0, 0.1f0, 0.05f0, 0.01f0, 0.005f0]))[:]
exdf = DataFrame()
for gnnparams in collect(Iterators.product([1f0, 0.1f0, 0.01f0],[1f0, 0.5f0]))[:]
