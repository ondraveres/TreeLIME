...
model
#@save "cape_equal_dropout_extractor2.jld2" extractor sch data model
@save "simpler_model.jld2" labelnames df_labels time_split_complete_schema extractor data model
# using Plots
